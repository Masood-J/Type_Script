...
//Q#04
let author_name = "Socrates";
let quote = "To know, is to know that you know nothing. That is the meaning of true knowledge.";
console.log(`${author_name}, once said: ${quote}`);
//Q#05
let famous_person = "Socrates";
let message = "Knowledge is power. Information is liberating. Education is the premise of progress, in every society, in every family.";
...
//Q#20 Mountain List
let mountain_array = ["k2", "Everest", "Himaliyas", "Alps"];
...
let array_cars = ["mustang", "lambo", "Viper", "Tesla"];
...
const current_users = ['alice', 'bob', 'charlie', 'david', 'emily'];
const new_users = ['john', 'sarah', 'CHARLIE', 'david', 'olivia'];
